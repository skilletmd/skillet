import { CATEGORY_SWATCHES, type CategoryKey } from './covers.js';

/** Tie-break order, and the set scored. Derived from the swatches rather than
 *  restated, so the taxonomy has one definition in this package. */
const CATEGORY_KEYS = Object.keys(CATEGORY_SWATCHES) as CategoryKey[];
